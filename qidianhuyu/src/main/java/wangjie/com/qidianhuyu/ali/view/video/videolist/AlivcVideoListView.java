...
import wangjie.com.qidianhuyu.ali.constants.LittleVideoParamConfig;
import wangjie.com.qidianhuyu.ali.utils.ToastUtils;
...
public class AlivcVideoListView extends FrameLayout {
    ...
    private void init() {
        ...
        refreshView.setColorSchemeColors(Color.BLACK);
        ...
        if (mListPlayer != null) {
            ...
            for (IVideoSourceModel iVideoSourceModel : list) {
                if (iVideoSourceModel.getSourceType() == VideoSourceType.TYPE_STS) {
                    ...
                    String url = iVideoSourceModel.getUri();
        ...
        if (mListPlayer != null) {
            for (IVideoSourceModel iVideoSourceModel : list) {
                if (iVideoSourceModel.getSourceType() == VideoSourceType.TYPE_STS) {
                    ...
                    mListPlayer.addUrl(iVideoSourceModel.getUri(), iVideoSourceModel.getUUID());
                }
            }
        }
    ...
    /**
     * 视频播放完成通知
     * @param onCompleteListern
     */
    public void setOnCompleteListern(IPlayer.OnCompletionListener onCompleteListern) {
        this.onCompletionListener = onCompleteListern;
    }
